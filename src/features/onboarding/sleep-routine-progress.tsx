...
import { SleepRoutine, SleepRoutineProgress } from '@/lib/sleep-routine';
    ...
    <div className="space-y-4">
      <div className="flex flex-row gap-3">
        <Card className="flex-1 min-w-0">
          <CardContent className="p-3 flex flex-col items-center gap-3 lg:items-start lg:gap-2">
            <Moon className="h-4 w-4 text-primary" />
            <span className="text-sm text-muted-foreground">Bedtime</span>
            <p className="text-xl font-semibold text-center lg:text-left">{bedtime || '00:00 PM'}</p>
          </CardContent>
        </Card>
        <Card className="flex-1 min-w-0">
          <CardContent className="p-3 flex flex-col items-center gap-3 lg:items-start lg:gap-2">
            ...
            <p className="text-xl font-semibold text-center lg:text-left">{wakeTime || '00:00 AM'}</p>
          </CardContent>
        </Card>
        <Card className="flex-1 min-w-0">
          <CardContent className="p-3 flex flex-col items-center gap-3 lg:items-start lg:gap-2">
            ...
            <p className="text-xl font-semibold text-center lg:text-left">{formatDuration(hoursSlept)}</p>
          </CardContent>
        </Card>
      </div>
