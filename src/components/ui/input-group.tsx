  ...
  return (
    <div
      ...
      className={cn(
        ...
        "h-9 has-[>textarea]:h-auto has-[[data-slot=input-group-control]]:h-auto",
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        "flex-1 resize-none rounded-none border-0 bg-transparent py-3 shadow-none focus-visible:ring-0 dark:bg-transparent w-full",
        className
      )}
      {...props}
    />
